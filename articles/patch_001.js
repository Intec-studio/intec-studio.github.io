  ...
  html: {
    ...
    <!-- MODULE: BANNER -->
        <div class="hero-card" style="margin-bottom: 18px;">
            <div class="hero-banner" style="height: 441px; background-image: linear-gradient(135deg, #1F1F1F 0%, #8C8C8C 12.5%, #E7E7E7 25%, #8C8C8C 37.5%, #1F1F1F 50%, #8C8C8C 62.5%, #E7E7E7 75%, #8C8C8C 87.5%, #1F1F1F 100%); background-size: 150vw 150vw; animation: gradientFlow 18s linear infinite; border-radius: 9px 9px 0 0;">
