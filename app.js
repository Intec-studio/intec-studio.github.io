        ...
        for (let ix = 0; ix < consDots; ix++) {
            for (let iy = 0; iy < consDots; iy++) {
                ...
                // ТВОЙ НОВЫЙ БЛОК:
                    ...
                    // Матрица пиксель-арта строго по картинке (28 ширина, 26 высота)
                    ...
                    // ИСПРАВЛЕНИЕ ЗДЕСЬ: Убрали минус перед pny, чтобы Y не инвертировался
                    ...
                    if (col >= 0 && col < gridWidth && row >= 0 && row < gridHeight) {
                        ...
                        if (char === '#') {
                            ...
                            alpha = 0.65; // Желтый (светло-серый)
                        } else if (char === 'W') {
                            alpha = 1.0;  // Белый (яркий)
                        } else if (char === 'O') {
                            alpha = 0.35; // Оранжевый (темно-серый)
                        } else if (char === '.') {
