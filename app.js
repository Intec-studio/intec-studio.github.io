            ...
            for (let iy = 0; iy < consDots; iy++) {
                ...
                // ТВОЙ НОВЫЙ БЛОК:
                    ...
                    const grid = [
                        ...
                        "    ##----------------------------##    ", // 7
                        "   ##------------------------------##   ", // 8
                        "  ################----################  ", // 9 (Надежная верхняя оправа)
                        "  ################----################  ", // 10
                        "  #----###  ####-######-####  ###----#  ", // 11 (Стекла и блики)
                        "  #----###  ####-#----#-####  ###----#  ", // 12
                        "  #----#########-#----#-#########----#  ", // 13 (Надежная нижняя оправа)
                        "  #----#########-#----#-#########----#  ", // 14
                        "   ##----#####---#----#---#####----##   ", // 15
                        "   ##--########----------########--##   ", // 16
                        "     ##--------------------------##     ", // 17
                    ...
                    // Простое вычисление позиции с учетом плавной анимации
                    ...
                    if (col >= 0 && col < gridWidth && row >= 0 && row < gridHeight) {
                        ...
                        if (char === ' ') {
                            ...
                            // Зубы 
                            let isTeeth = (row >= 20 && row <= 21) && ((col >= 17 && col <= 18) || (col >= 21 && col <= 22));
                            if (isTeeth) {
                                alpha = 1.0; 
                            } else {
                                alpha = 0.15; // Темная оправа
                            }
                        } else if (char === '-') {
                            // Внутри рта
                            let isInnerMouth = (row >= 20 && row <= 22) && (col >= 14 && col <= 25);
                            if (isInnerMouth) {
                                alpha = 0.25; 
                            } else {
                                alpha = 0.65; // Светлая кожа
                            }
                        }
                    }
                }
