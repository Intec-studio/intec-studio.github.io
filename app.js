        ...
        for (let ix = 0; ix < consDots; ix++) {
            for (let iy = 0; iy < consDots; iy++) {
                ...
                // ТВОЙ НОВЫЙ БЛОК:
                    ...
                    // Идеально сглаженная матрица 40x27 (утолщенная полоска кожи на лбу)
                    const grid = [
                        "             ##############             ", // 0
                        "          ####------------####          ", // 1
                        "        ###------------------###        ", // 2
                        ...
                        "  ##---####------------------####---##  ", // 7
                        " ##----------------------------------## ", // 8 (Кожа - слой 1)
                        " ##----------------------------------## ", // 9 (Кожа - слой 2, защита от сливания)
                        " #################----################# ", // 10 (Очки)
                        " #-----###  ###--######--###  ###-----# ", // 11
                        " #-----###  ###--#----#--###  ###-----# ", // 12
                        " #-----########--#----#--########-----# ", // 13
                    ...
                    let gridWidth = 40;
                    let gridHeight = 27; // Увеличили высоту матрицы
                    
                    // Фиксированный масштаб
                    let pixelSizeX = 0.045; 
                    let pixelSizeY = 0.058; 
                    
                    // Жесткая анимация (защита от искажения формы)
                    ...
                    if (col >= 0 && col < gridWidth && row >= 0 && row < gridHeight) {
                        ...
                        if (char === ' ') {
                            // Сдвинули проверку бликов на 1 строку вниз (11 и 12)
                            let isGlare = (row === 11 || row === 12) && ((col >= 10 && col <= 11) || (col >= 28 && col <= 29));
                            if (isGlare) {
                                alpha = 1.0; 
                            }
                        } else if (char === '#') {
                            // Сдвинули зубы на 1 строку вниз (с 20 по 22)
                            let isTeeth = (row >= 20 && row <= 22) && ((col >= 15 && col <= 17) || (col >= 22 && col <= 24));
                            if (isTeeth) {
                                alpha = 1.0; // Зубы
                            } else {
                                alpha = 0.15; // Контур
                            ...
                            // Сдвинули рот на 1 строку вниз (с 20 по 23)
                            let isInnerMouth = (row >= 20 && row <= 23) && (col >= 13 && col <= 26);
                            if (isInnerMouth) {
                                alpha = 0.25; // Темнота во рту
                            } else {
                                alpha = 0.65; // Кожа лица
                            }
                        }
                    }
                }
